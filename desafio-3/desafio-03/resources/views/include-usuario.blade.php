            ...
            @csrf
                ...
                <div class="form-group">
                    <label for="senha">senha</label>
                        <input name="senha" type="text" class="form-control" placeholder="Digite sua Senha" required>
                </div>
                <div class="form-group">
                    <label for="name">Data Nascimento</label>
                        <input name="dataNascimento" type="date" class="form-control" placeholder="Digite sua data de nascimento" required>
                </div>
